function unconditional_table = get_thinning_unconditional_table()
    ...
    % L Cluster
    unconditional_table(:,:,160) = [ 0 0 1; 0 1 1; 0 0 0 ];
    unconditional_table(:,:,161) = [ 0 1 1; 0 1 0; 0 0 0 ];
    unconditional_table(:,:,162) = [ 1 1 0; 0 1 0; 0 0 0 ];
    unconditional_table(:,:,163) = [ 1 0 0; 1 1 0; 0 0 0 ];
    unconditional_table(:,:,164) = [ 0 0 0; 1 1 0; 1 0 0 ];
    unconditional_table(:,:,165) = [ 0 0 0; 0 1 0; 1 1 0 ];
    unconditional_table(:,:,166) = [ 0 0 0; 0 1 0; 0 1 1 ];
    unconditional_table(:,:,167) = [ 0 0 0; 0 1 1; 0 0 1 ];
